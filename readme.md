...
### ```Note✨: I have another amazing project on``` [end-to-end-encrypted-chat-application](https://github.com/Nitish-95/mern-chat) ```using Next.js, Prisma, Postgresql, Express, Socket.io.```
...
![ecommerce-homepage](https://github.com/Nitish-95/mern-ecommerce/blob/main/frontend/src/assets/images/front.png?raw=true)
<!-- ![ecommerce-banner](https://github.com/Nitish-95/mern-ecommerce/blob/main/frontend/src/assets/images/banner4.jpg?raw=true) -->
![ecommerce-banner](https://github.com/Nitish-95/mern-ecommerce/blob/main/frontend/src/assets/images/banner3.jpg?raw=true)
...
```bash
  git clone https://github.com/Nitish-95/mern-ecommerce.git
```
